#!/usr/bin/env python
"""
DESCRIPTION: This script is for testing depth sensing using the disparity concept.
"""
import cv2
import numpy as np

frame = cv2.imread('../media/left.png', cv2.IMREAD_COLOR)
frame2 = cv2.imread('../media/right.png', cv2.IMREAD_COLOR)
